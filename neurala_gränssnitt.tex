...
% xxx Fråga:
% Kan ''respektive'' användas i meningen nedan? Vill försöka undvika att skriva
% ''olika'' två gånger.
% xxx
...
och kräver därför kirurgiska ingrepp. Andra neurala gränssnitt kan mäta de
magnetfält som alstras av nervimpulser i hjärnan på avstånd, och kräver därför
inga kirurgiska ingrepp; mer om detta i sektion \ref{meg}.
...
% xxx Word:
% Kan ''lagringsutrymmet'' användas i detta avseende? D.v.s. minskar filens
% storlek.
% xxx
...
lagringsutrymmet och öka överföringshastigheten. Liknande forskning har
bedrivits för att studera hur auditativ stimuli från örat omkodas innan de
överförs via hörselnerven till hjärnan.
...
när man är svettig så påverkas impulsen vilket gör avläsningarna mindre
pålitliga \cite{prosthetic_operation}.

\subsubsection{Elektroencefalografi}

Även elektroencefalografi (EEG) använder sig av ytelektroder, men istället för
