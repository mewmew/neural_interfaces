...
synnerven till hjärnan har en lyckats härleda hur den visuella informationen
...
ska acceptera protesen som en del av sin kropp\footnote{I dagsläget väljer
ungefär hälften av personer med protes att ta av sig protesen när den inte
används, då protesen inte känns som en del av deras kropp}.
\cite{prosthetic_operation}
...
gränssnitt kan sedan vem som helst ansluta sig till och använda sig av det
kollektiva minnet.
...
tolka nya sorters stimuli kan jämföras med att förstå sig på nya språk, det är
...
Självklart behöver en ta hänsyn till etiska och moraliska aspekter. T.ex. borde
